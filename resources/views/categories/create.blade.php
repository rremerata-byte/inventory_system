        ...
        <div class="card-body">
            ...
            <form action="{{ route('categories.store') }}" method="POST" class="category-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" placeholder="e.g., Natasha" value="{{ old('name') }}" required>
                </div>

                <div class="form-group">
                    <label for="color_code" class="form-label">Color Code (Optional)</label>
                    <div class="color-picker-wrapper">
                        <input type="color" id="color_code" name="color_code" class="form-control color-picker" value="{{ old('color_code', '#2ecc71') }}" onchange="updateColorPreview()">
                        <input type="text" id="color_code_text" class="form-control color-text" placeholder="#2ecc71" value="{{ old('color_code', '#2ecc71') }}" onchange="updateColorPicker()" readonly>
                        <div id="color-preview" class="color-preview" style="background-color: #2ecc71;"></div>
                    </div>
...
.btn-primary {
    background: linear-gradient(135deg, #ff0000ff, #FF7F00, #FFFF00, #00FF00, #0000FF, #4B0082, #9400D3);
    color: white;
}
